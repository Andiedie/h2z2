...
void Shotgun::fire() {
	...
	auto bullet = new Bullet(file, pos + 45.0f * b1, damage, player->getRotation(), 1000.0f);
	scene->addChild(bullet);
	bullet->broadcast();
	bullet = new Bullet(file, pos + 45.0f * b2, damage, player->getRotation(), 1000.0f);
	scene->addChild(bullet);
	bullet->broadcast();
	bullet = new Bullet(file, pos + 45.0f * b3, damage, player->getRotation(), 1000.0f);
	scene->addChild(bullet);
	bullet->broadcast();
	bullet = new Bullet(file, pos + 45.0f * b4, damage, player->getRotation(), 1000.0f);
	scene->addChild(bullet);
	bullet->broadcast();
	bullet = new Bullet(file, pos + 45.0f * b5, damage, player->getRotation(), 1000.0f);
	scene->addChild(bullet);
	bullet->broadcast();
